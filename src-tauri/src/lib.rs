...
async fn launch_instance(app: tauri::AppHandle, instance: String) -> Result<String, String> {
    ...
    // resolve identity: ely.by account (skins/capes render via authlib-injector) or offline fallback
